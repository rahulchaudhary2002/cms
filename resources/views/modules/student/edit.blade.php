        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="row permission-container">
                    ...
                    $userPermissionsIds = $student->permissions()->pluck('permission_id')->toArray();
                    @endphp
                    <div class="col-md-12">
                    ...
                    <div class="col-md-3">
                        <div class="card">
                            <div class="card-header d-flex-space-between">
                                <div class="checkbox">
                                    <input type="checkbox" class="check-permission" onchange="childrenPermissionCheckbox('{{ $type }}', this)" id="check-permission-{{ $type }}" @if(!array_diff($subset, $student->getPermissionIdsByType($type))) checked @endif>
                            ...
                            <div class="card-body">
                                ...
                                <div class="checkbox mt-2 mb-2">
                                    <input class="check-permission check-permission-{{ $type }}" onchange="parentPermissionCheckbox('{{ $type }}', this)" type="checkbox" name="permissions[]" value="{{ $value->id }}" id="permission-{{ $type }}-{{ $key }}" @if($student->hasPermissionTo($value->key)) checked @endif>
