            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex-space-between">
                        <h1 class="card-title">Create Meeting</h1>
                        ...
                        <div class="row mb-2">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input id="topic" class="form-control" type="text" name="topic" placeholder="Topic" value="{{ old('topic') }}">
                                    @error('topic')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="start-time" class="form-control" type="datetime-local" name="start_time" placeholder="Start Time" value="{{ old('start_time') }}">
                                    @error('start_time')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="duration" class="form-control" type="text" name="duration" placeholder="Duration in minutes" value="{{ old('duration') }}">
                                    @error('duration')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
