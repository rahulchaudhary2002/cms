...
@section('content')
<div class="container">
    <form action="{{ route('course.update', $course->key) }}" method="POST">
        @csrf
        @method("PUT")
        <div class="row">
            <div class="col-md-12">
                        ...
                        <div class="row mb-2">
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input id="name" class="form-control" type="text" name="name" placeholder="Name" value="{{ $course->name }}" >
                                    @error('name')
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input id="course-code" class="form-control" type="text" name="course_code" placeholder="Course Code" value="{{ $course->course_code }}" >
                                    @error('course_code')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input id="credit" class="form-control" type="number" name="credit" placeholder="Credit" value="{{ $course->credit }}" >
                                    @error('credit')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="program" id="program"  data-init-plugin="select2" data-semesters="{{ $semesters }}" data-course="{{ $course }}">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div class="checkbox mt-2 mb-2">
                                        <input type="checkbox" id="check-elective" name="elective" value="1" @if($course->elective == 1) checked @endif>
...
<script>
    $(document).ready(function() {
        ...
        // Initial call to updateSemesterOptions
        updateSemesterOptions();
    });

    function updateSemesterOptions() {
        let semesters = $('#program').data('semesters');
        let course = $('#program').data('course');
        ...
        var optionStrings = filteredSemesters.map(element => {
            return `<option value="${element.id}" ${course.program_id === element.program_id ? 'selected' : ''}>${element.name}</option>`;
        });
