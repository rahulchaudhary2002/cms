                ...
                <div class="card">
                    ...
                    <div class="card-body expand">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="academic_year" id="academicYear"  data-init-plugin="select2">
                                        ...
                                        <option value="{{ $academicYear->id }}" @if(old('academic_year') == $academicYear->id) selected @endif>{{ $academicYear->name }}</option>
                                        @empty
                                        @endforelse
                                    </select>
                                    @error('academic_year')
                            ...
                            <div class="col-md-12">
                                <div class="checkbox">
                                    <input type="checkbox" id="allow-late-submission" name="allow_late_submission" value="1" @if(old('allow_late_submission') == 1) checked @endif>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="description" id="description" data-init-plugin="ckeditor"  placeholder="Assignment Description">{!! old('description') !!}</textarea>
                                    @error('description')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body expand">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="question-title">Question Title <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="answer_types[1]">
                                    @error('answer_types')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6 multiple-upload hidden">
                                <div class="checkbox mt-6">
                                    <input type="checkbox" id="multiple-upload-1" class="multiple-upload-checkbox">
                                    <label for="multiple-upload-1">Allow Multiple File Uploads</label>
                                </div>
                                <input class="multiple-file-upload" type="hidden" name="multiple_file_uploads[1]" value="0">
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="question-description">Description</label>
                                    <textarea id="question-description" class="form-control" name="question_descriptions[1]" placeholder="Question Description" data-init-plugin="ckeditor"></textarea>
                                </div>
                            </div>
                            <div class="col-md-12 submit-button">
                                <button class="btn btn-md btn-primary">Submit</button>
...
<script>
    ...
    var question_num = (lastKey && lastKey >= 2) ? lastKey + 1 : 2;
