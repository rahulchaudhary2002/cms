...
@section('title', 'Create Examination Stage')
...
@section('content')
<div class="container">
    <form action="{{ route('examination.stage.store') }}" method="POST">
        @csrf
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex-space-between">
                        <h1 class="card-title">Create Examination Stage</h1>
                        ...
                        <div class="row mt-2 mb-2">
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="semester" id="semester"  data-init-plugin="select2" data-semesterId="{{ old('semester') }}" data-sessions="{{ $sessions }}">
